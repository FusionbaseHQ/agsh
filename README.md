...
verification, not a separate Actions build-provenance attestation, which the
release workflow does not currently claim. A checksum fetched from the same
release detects corruption but is not independent proof of origin. License
